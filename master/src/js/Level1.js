class Level1 extends Phaser.Scene {
    ...
    preload() {
        ...
        //carga de fondo
        this.load.image("background", "../../resources/img//fondol1.png");

        //boton de pausa
        this.load.image("pause", "../../resources/img/pausa.png");
        ...
        this.load.spritesheet('vivo', '../../resources/img/spritesVivoDef.png', { frameWidth: fStandarWidth - 10, frameHeight: fStandarHeight, endframe: endF });
        ...
        //collider pared
        this.load.spritesheet('invisibleCollider','../../resources/img/invisible.png',{frameWidth: 800, frameHeigh:100 , endframe:1});
        ...
        this.load.image('corazon', '../../resources/img//cora.png');
        this.load.image('tuertoLife', '../../resources/img//tuertoLife.png');
        this.load.image('vivoLife', '../../resources/img//vivoLife.png');
    }
